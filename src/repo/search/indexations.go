...
func (r *Repository) GenerateBlindIndexes(messageID uint64, chatID string, text string) []dbm.MessageSearchIndex {
...
func (r *Repository) SearchMessages(chatID string, query string) ([]uint64, error) {
